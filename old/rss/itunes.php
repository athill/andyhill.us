...
<title>Soundslam New Releases</title>
...
<?php
$feed = "http://ax.phobos.apple.com.edgesuite.net/WebObjects/MZStore.woa/wpa/MRSS/newreleases/sf=143441/genre=0000800/limit=10/rss.xml";

$code = file($feed) or die("Couldn't open remote file");
$name = "itunes.rss";
