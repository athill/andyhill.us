												...
												<div <?php post_class('actual_post') ?> id="post-<?php the_ID(); ?>">
													<div class="ta_meta_container">
                                                        ...
                                                        <div class="featured_section_header">                            
                                                                <?php the_post_thumbnail( 'Tealthumbfull' ); ?>
                                                        </div>              
                                                        <?php endif; ?>                                                    
                                                        ...
                                                        <div class="actual_post_author">
                                                            <div class="actual_post_posted"><?php _e('Posted by : ','Teal'); ?><span><?php the_author() ?></span> <?php _e('On : ','Teal'); ?> <span><?php the_time(get_option( 'date_format' )) ?></span></div>
                                                        ...
                                                        <div class="metadata">
                                                            <p>
                                                                <span class="label"><?php _e('Category:', 'Teal') ?></span>
                                                                <span class="text"><?php the_category(', ') ?></span>
                                                            </p>
                                                            <?php the_tags('<p><span class="label">'.__('Tags:','Teal').'</span><span class="text">', ', ', '</span></p>'); ?>
													...
													<div class="post_entry">
														...
														<div class="entry">
															<?php the_content(__('<span>Continue Reading >></span>', 'Teal')); ?>
															<div class="clear"></div>
															<?php wp_link_pages( array( 'before' => '<div class="page-link"><span>' . __( 'Pages:', 'Teal' ) . '</span>', 'after' => '</div>' ) ); ?>	
                                                          	<?php 
																
																if (is_attachment()){ 
																	echo '<p class="Teal_prev_img_attch">';
																	previous_image_link( false, '&#171; '.__('Previous Image' , 'Teal').'' ); 
																	echo '</p>';
																}  
															?> 
                                                          	<?php 
																...
																if (is_attachment()){ 
																	echo '<p class="Teal_prev_img_attch">';
																	next_image_link( false, ''.__('Next Image' , 'Teal').' &#187;' );
																	echo '</p>'; 
																}
															?>                                                                                                                        																			
														</div>
                                                    ...
                                                    <div class="post_author_bio">
                                                        ...
                                                        <div class="post_author_bio_social">
                                                            	...
                                                            	<?php 
																	$authorswebsitelink =  Teal_get_custom_field('authors_website', get_the_ID(), true);
                                                                ...
                                                                <div class="authors_website">
                                                                	...
                                                                	<p><a href="<?php echo $authorswebsite; ?>"><?php _e("Visit Author's Website",'Teal'); ?></a></p>
                                                            	</div>
                                                                <?php endif; ?>
                                                            
                                                        	
                                                            	<?php 
																	$authorstwitterlink =  Teal_get_custom_field('authors_twitter', get_the_ID(), true);
                                                                ...
                                                                <div class="authors_twitter">                                                           
                                                            		<p><a href="https://www.twitter.com/<?php echo $authorstwitter; ?>"><?php _e("Follow On Twitter",'Teal'); ?></a></p>
                                                            	</div>  
                                                            	<?php endif; ?>
                                                            	...
                                                            	<?php 
																	$authorsfacebooklink =  Teal_get_custom_field('authors_facebook', get_the_ID(), true);
                                                                ...
                                                                <div class="authors_facebook">                                                           
                                                            		<p><a href="<?php echo $authorsfacebook; ?>"><?php _e("Like On Facebook",'Teal'); ?></a></p>
                                                            	</div>
																<?php endif; ?>                                                                                                                      
                                                    ...
                                                    <div class="single_newsletter">
                                                    	...
                                                    	<div class="single_newsletter_heading">
                                                        	<p><a href="<?php echo get_feed_link( 'rss2' ); ?>"><?php _e('Subscribe To RSS','Teal'); ?></a></p>
                                                        </div>                                                     
                                                    ...
                                                    <div class="single_np">
                                                          	...
                                                          	<?php 
																...
																previous_post_link('<div class="single_np_prev"><p class="single_np_prev_np">'.__('Previous Post' , 'Teal').'</p><p> %link</p></div>');
															...
															?>                                                            
                                                          	...
                                                          	<?php 
																...
																next_post_link('<div class="single_np_next"><p class="single_np_next_np">'.__('Next Post' , 'Teal').'</span></p><p> %link</p></div>');
