                        ...
                        <div id="sidebar_section">
                                    ...
                                    <div id="sidebarads_250">
										<?php if( dynamic_sidebar('sidebar-ads') ){
                                               ...
                                               <p class="sidebar_ad_250">
                                               		<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/300default.png" alt="" />
                                               </p>                                
                            ...
                            <div id="feed_social">
                                            ...
                                            <div id="sidebar_facebook">
                                            	...
                                            	<p><a href="<?php echo esc_url( of_get_option('facebook_id') ); ?>"><?php _e('Be A Fan On Facebook', 'Teal') ?></a></p>
                                            ...
                                            <div id="sidebar_twitter">
                                            	...
                                            	<p><a href="http://www.twitter.com/<?php echo esc_attr( of_get_option('twitter_id') ); ?>"><?php _e('Follow On Twitter',  'Teal') ?></a></p>                                            
										...
										<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('left') ){
																		...
																		<div class="sidebar_widget">
																			...
																			<div class="widget widget_categories">
																				<h3 class="widgettitle"><?php _e('Categories', 'Teal') ?></h3>
																				<ul>
                            ...
                            <div id="sidebar_right">
										...
										<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('right') ){
																		...
																		<div class="sidebar_widget">
																			...
																			<div class="widget widget_categories">
																				<h3 class="widgettitle"><?php _e('Archives', 'Teal') ?></h3>
																				<ul>
																		...
																		<div class="sidebar_widget">
																			...
																			<div class="widget widget_categories">
																				<h3 class="widgettitle"><?php _e('Blogrolls', 'Teal') ?></h3>
																				<ul>
