...
<tr>
    ...
    the web, and network technologies.
    </td>
</tr>
<tr>
    ...
    <td class="right-col">
    <div>
    <strong>Coursera</strong>, <a href="https://www.coursera.org/" target="_blank">https://www.coursera.org/</a>
    </div>
...
<tr>
    ...
    <div class="clear indent1">
        <em>University Student Services and Systems, formerly Student Enrollment Services</em>
    </div>
    ...
    <ul class="clear">
        ...
        <li>Led project creating web form infrastructure which centralizes settings for rendering, updating, securing, and validating (both client and server side) web forms while offering flexiblility in form layout and database updates.</li>
    </ul>
    <div class="clear indent1">
    ...
    <div class="title-date indent2">
        <div class="title">
        Computer Lab Monitor, Phone/Walk-in Support
        </div>
        <div class="date">
    ...
    <div class="clear indent3">
    Started as a computer lab consultant, was promoted to Support Staff position in May of 2002, which entailed supervising 140 consultants, updating internal web pages, acting as go-between to 
